...
ax1.set_title("Grover Probability Growth (30 Qubits)", fontsize=16)
...
zoom_range = range(max(0,k_opt-50), k_opt+50)
...
plt.tight_layout()
plt.savefig("grover_30q_full.png")

print("Saved -> grover_30q_full.png")