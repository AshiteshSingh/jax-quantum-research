...
# ----------------------------
accuracy = p_opt * 100
speedup = np.sqrt(N)   # Grover complexity
...
ax1.set_title("Grover Probability Growth", fontsize=16)
...
zoom_range = range(max(0,k_opt-20), k_opt+20)
...
plt.tight_layout()
plt.savefig("grover_20q_full.png")

print("Saved -> grover_20q_full.png")
